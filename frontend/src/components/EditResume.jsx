...
const EditResume = () => {
    ...
    // It will help in preview and as well as downloading the resume also saves the resume as image
...
// Type of how it will look when downloaded
        try {
            await html2pdf()
                ...
                .from(element)
                .save();  // saves the resume to downloaded when needed
                            ...
                            <div className={containerStyles.formContainer}>
                                ...
                                <div className="p-4 sm:p-6">
                                    ...
                                    <div className="flex flex-wrap items-center justify-end gap-3">
                                        ...
                                        <button className={buttonStyles.next} onClick={validateAndNext} disabled={isDownloading}>
