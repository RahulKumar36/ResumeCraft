...
import { Layers2, X, Menu, ArrowRight, Zap, LayoutTemplate, Download} from 'lucide-react';
            ...
            <div className={landingPageStyles.container}>
                    ...
                    <div className={landingPageStyles.headerContainer}>
                        <div className={landingPageStyles.logoContainer}>
                            <div className={landingPageStyles.logoIcon}>
                                <Layers2 className={landingPageStyles.logoIconInner} />
                            </div>
                            ...
                            {user ? (<ProfileInfoCard />) :
                                (
                                    <button className={landingPageStyles.desktopAuthButton} onClick={() => setOpenAuthModal(true)}>
                                        {/* FIX: Corrected button structure for hover effect */}
                ...
                <main className={landingPageStyles.main}>
                    <section className={landingPageStyles.heroSection}>
                        {/* FIX: Added heroGrid container to wrap both left and right sides */}
                        <div className={landingPageStyles.heroGrid}>
                            ...
                            <div className={landingPageStyles.heroLeft}>
                                ...
                                <p className={landingPageStyles.description}>
                                    Creates job-winning resumes with expertly designed templates.
                                ...
                                <div className={landingPageStyles.statsContainer}>
                                    {[
                                        { value: '50K+', label: 'Resumes Created', gradient: 'from-rose-400 to-fuchsia-500' },
                                        { value: '4.9★', label: 'User Rating', gradient: 'from-red-400 to-rose-400' },
                                        { value: '5 Min', label: 'Build Time', gradient: 'from-purple-500 to-violet-500' }
                                    ].map((stat, idx) => (
                        ...
                        <div className={landingPageStyles.featuresContainer}>
                            <div className={landingPageStyles.featuresHeader}>
                                ...
                                <p className={landingPageStyles.featureDescription}>
                                    Instantly craft a professional, ATS-friendly resume that gets you hired faster with the power of AI.
                            ...
                            <div className={landingPageStyles.ctaCard}>
                                <div className={landingPageStyles.ctaCardBg}></div>
                                    <div className={landingPageStyles.ctaCardContent}>
                                        ...
                                        Join Thousands Of Professional Who Landed Their Dream Jobs With Help From Our PlatForm. 
                                        </p>
                ...
                <footer className={landingPageStyles.footer}>
                    <div className={landingPageStyles.footerContainer}>
                        <p className={landingPageStyles.footerText}>
                            Crafted with <span className={landingPageStyles.footerHeart}>❤️</span> by Rahul
