        ...
        <>
            <div className={styles.background}>
                <DashboardLayout>
                        ...
                        {!loading && allResumes.length === 0 && (
                            <div className={styles.emptyStateWrapper}>
                                ...
                                <p className={styles.emptyText}>
                                    You havn't created any resume yet. Start building your professional resume to land your dreama job!
                                </p>
                    ...
                    {/*Delete Modal */}
                    <Modal isOpen={showDeleteConfirm} onClose={() => setShowDeleteConfirm(false)} title='confirm deletetion'
